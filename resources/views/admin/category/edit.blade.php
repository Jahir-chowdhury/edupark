              ...
              <div class="form-row">
               <!-- <div class="col-md-6">
				...
				<div class="form-group">
					...
					{!! Form::hidden('id',$categoryById->id,['class' => 'form-control'])!!}
				</div>
				</div>
				 <div class="col-md-6">
				<div class="form-group">
					{!! Form::label('CategoryStatus', 'CategoryStatus:', ['class' => 'control-label']) !!}
					{!! Form::text('CategoryStatus',$categoryById->CategoryStatus , ['class' => 'form-control']) !!}
				</div>
				</div>
                <div class="col-md-6">
				<div class="form-group">
					{!! Form::label('CategoryDescription', 'CategoryDescription:', ['class' => 'control-label']) !!}
					{!! Form::textarea('CategoryDescription', $categoryById->CategoryDescription, ['class' => 'form-control']) !!}
				</div>
